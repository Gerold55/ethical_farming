...
crop_def.drop = {
	items = {
		{items = {'farming:bronze_essence'}, rarity = 1},
		{items = {'farming:bronze_essence'}, rarity = 2},
		{items = {'farming:bronze_essence'}, rarity = 3},
...
crop_def.drop = {
	items = {
		{items = {'farming:bronze_essence 2'}, rarity = 1},
		{items = {'farming:bronze_essence 2'}, rarity = 2},
		{items = {'farming:bronze_essence 2'}, rarity = 2},
		{items = {'farming:seed_bronze'}, rarity = 1},
		{items = {'farming:seed_bronze'}, rarity = 3},
	}
